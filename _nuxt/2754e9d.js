     ...
     Ft("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",
      ...
      var rr = function(t, e) {
        ...
        return e.delay = function(t) {
          ...
          return arguments.length
                     ? this.totalDuration(this._repeat > 0
                                              ? t + (t + this._rDelay) *
                                                        this._repeat
                                              : t)
          ...
          if (r && r.smoothChildTiming && this._ts) {
            for (re(this, t), !r._dp || r.parent || ie(r, this); r.parent;)
              r.parent._time !==
                      r._start + (r._ts >= 0 ? r._tTime / r._ts
                                             : (r.totalDuration() - r._tTime) /
                                                   -r._ts) &&
                  r.totalTime(r._tTime, !0),
                  r = r.parent;
            !this.parent && this._dp.autoRemoveChildren &&
                (this._ts > 0 && t < this._tDur || this._ts < 0 && t > 0 ||
                 !this._tDur && !t) &&
                ne(this._dp, this, this._start - this._delay)
          }
          return (this._tTime !== t || !this._dur && !e ||
          ...
          return arguments.length ? this.totalTime(this.totalDuration() * t, e)
                 : this.totalDuration() ? Math.min(1, this._tTime / this._tDur)
                                        : this.ratio
          ...
          return arguments.length
                     ? this.totalTime(
                           this.duration() *
                               ...
                               $t(this),
                           e)
                 : this.duration() ? Math.min(1, this._time / this._dur)
                                   : this.ratio
        }, e.iteration = function(t, e) {
          var r = this.duration() + this._rDelay;
          return arguments.length ? this.totalTime(this._time + (t - 1) * r, e)
                 : this._repeat   ? Kt(this._tTime, r) + 1
                                  : 1
          ...
          if (this._rts === t)
            return this;
          var e = this.parent && this._ts ? te(this.parent._time, this)
                                          : this._tTime;
          ...
          if (arguments.length) {
            var time = this._time;
            return this._rDelay = t, fe(this), time ? this.time(time) : this
          }
          return this._rDelay
        }, e.yoyo = function(t) {
          ...
          return !(e && !(this._ts && this._initted && e.isActive() &&
                          (t = e.rawTime(!0)) >= r && t < this.endTime(!0) - V))
        }, e.eventCallback = function(t, e, r) {
          var n = this.vars;
          return arguments.length > 1
                     ? (e ? (n[t] = e, r && (n[t + "Params"] = r),
          ...
          return new Promise((function(r) {
            var n = $(t) ? t : Ut, o = function() {
              var t = e.then;
              e.then = null,
              $(n) && (n = n(e)) && (n.then || n === e) && (e.then = t), r(n),
              e.then = t
            };
      ...
      var nr = function(t) {
        ...
        return r.to = function(t, e, r) {
          ...
          return e.duration = 0, e.parent = this,
                 Gt(e).repeatDelay || (e.repeat = 0),
                 e.immediateRender = !!e.immediateRender,
                 new _r(t, e, pe(this, r), 1), this
        }, r.call = function(t, e, r) {
          return ne(this, _r.delayedCall(0, t, e), r)
        }, r.staggerTo = function(t, e, r, n, o, h, f) {
          return r.duration = e, r.stagger = r.stagger || n, r.onComplete = h,
                 r.onCompleteParams = f, r.parent = this,
                 new _r(t, r, pe(this, o)), this
          ...
          return n.startAt = r, Gt(n).immediateRender = it(n.immediateRender),
                 this.staggerTo(t, e, n, o, h, f, l)
        }, r.render = function(t, e, r) {
          var time, n, o, h, l, c, _, d, m, v, y, T,
              x = this._time,
              w = this._dirty ? this.totalDuration() : this._tDur,
              O = this._dur,
              M = this !== f && t > w - V && t >= 0 ? w
                  : t < V                           ? 0
                                                    : t,
          ...
          if (M !== this._tTime || r || k) {
            if (x !== this._time && O &&
                ...
                time = M, m = this._start, c = !(d = this._ts),
                k && (O || (x = this._zTime), (t || !e) && (this._zTime = t)),
                this._repeat) {
              if (y = this._yoyo, l = O + this._rDelay,
                  this._repeat < -1 && t < 0)
                return this.totalTime(100 * l + t, e, r);
              if (time = Et(M % l),
                  M === w ? (h = this._repeat, time = O)
                  ...
                  h !== v && !this._lock) {
                var A = y && 1 & v, C = A === (y && 1 & h);
                if (h < v && (A = !A), x = A ? 0 : O, this._lock = 1,
                    this.render(x || (T ? 0 : Et(h * l)), e, !O)._lock = 0,
                    this._tTime = M, !e && this.parent && Pe(this, "onRepeat"),
                    this.vars.repeatRefresh && !T &&
                        (this.invalidate()._lock = 1),
                    x && x !== this._time || c !== !this._ts ||
                        this.vars.onRepeat && !this.parent && !this._act)
                  return this;
                if (O = this._dur, w = this._tDur,
                    C && (this._lock = 2, x = A ? O : -1e-4, this.render(x, !0),
                          this.vars.repeatRefresh && !T && this.invalidate()),
                    this._lock = 0, !this._ts && !c)
                  return this;
                He(this, T)
              }
            }
            if (this._hasPause && !this._forcing && this._lock < 2 &&
                ...
                this._tTime = M, this._time = time, this._act = !d,
                this._initted || (this._onUpdate = this.vars.onUpdate,
                                  this._initted = 1, this._zTime = t, x = 0),
            ...
            if (time >= x && t >= 0)
              ...
              for (var D = t < 0 ? t : time; n;) {
                if (o = n._prev, (n._act || D <= n._end) && n._ts && _ !== n) {
                  if (n.parent !== this)
                    return this.render(t, e, r);
                  if (n.render(n._ts > 0
                                   ? (D - n._start) * n._ts
                      ...
                      e || t < 0 && !x || !M && !x && w ||
                          (Pe(this,
                              M === w && t >= 0 ? "onComplete"
                                                : "onReverseComplete",
                              !0),
                           this._prom && !(M < w && this.timeScale() > 0) &&
                               this._prom())))
          }
          return this
        }, r.add = function(t, e) {
          ...
          if (K(e) || (e = pe(this, e, t)), !(t instanceof ir)) {
            if (ot(t))
              return t.forEach((function(t) { return r.add(t, e) })), this;
            if (J(t))
          ...
          return J(t)   ? this.removeLabel(t)
                 : $(t) ? this.killTweensOf(t)
                        : (Wt(this, t),
          ...
          return arguments.length
                     ? (this._forcing = 1,
                        !this._dp && this._ts &&
                            (this._start =
                                 Et(Xe.time -
                                    (this._ts > 0 ? e / this._ts
                                                  : (this.totalDuration() - e) /
                                                        -this._ts))),
                        t.prototype.totalTime.call(this, e, r),
                        this._forcing = 0, this)
                     : this._tTime
          ...
          return n.data = "isPause", this._hasPause = 1,
                 ne(this, n, pe(this, t))
          ...
          e = e || {};
          var r,
              n = this, o = pe(n, t), h = e, f = h.startAt, l = h.onStart,
              c = h.onStartParams, _ = h.immediateRender,
              d = _r.to(
                  n, Nt({
                    ease : e.ease || "none",
                    lazy : !1,
          ...
          return arguments.length ? this.seek(t, !0)
          ...
          return this._dp && (this._time = this._tTime = this._pTime = 0),
                 t && (this.labels = {}), Ht(this)
        }, r.totalDuration = function(t) {
          var e, r, n, o = 0, h = this, l = h._last, c = X;
          if (arguments.length)
            return h.timeScale(
          ...
          if (h._dirty) {
            for (n = h.parent; l;)
              e = l._prev, l._dirty && l.totalDuration(),
              ...
              r < 0 && l._ts &&
                  (o -= r,
                   (!n && !h._dp || n && n.smoothChildTiming) &&
                       (h._start += r / h._ts, h._time -= r, h._tTime -= r),
                   h.shiftChildren(-r, !1, -Infinity), c = 0),
              l._end > o && l._ts && (o = l._end), l = e;
            he(h, h === f && h._time > o ? h._time : o, 1, 1), h._dirty = 0
          }
          return h._tDur
        }, e.updateRoot = function(time) {
          if (f._ts && (Lt(f, te(time, f)), m = Xe.frame), Xe.frame >= Ct) {
            Ct += U.autoSleep || 120;
            var t = f._first;
      ...
      var sr,
          ar =
              function(t, e, r, n, o, h, f) {
            var l, c, _, d, m, v, y, a,
                T = new Dr(this._pt, t, e, 0, 1, wr, null, o), x = 0, w = 0;
            for (T.b = r, T.e = n, r += "",
                (y = ~(n += "").indexOf("random(")) && (n = Ae(n)),
                h && (h(a = [ r, n ], t, e), r = a[0], n = a[1]),
                c = r.match(lt) || [];
                 l = lt.exec(n);)
              d = l[0], m = n.substring(x, l.index),
              _ ? _ = (_ + 1) % 5 : "rgba(" === m.substr(-5) && (_ = 1),
              d !== c[w++] && (v = parseFloat(c[w - 1]) || 0, T._pt = {
                _next : T._pt,
                p : m || 1 === w ? m : ",",
                s : v,
                c : "=" === d.charAt(1) ? parseFloat(d.substr(2)) *
                                              ("-" === d.charAt(0) ? -1 : 1)
                                        : parseFloat(d) - v,
                m : _ && _ < 4 ? Math.round : 0
              },
                               x = lt.lastIndex);
            return T.c = x < n.length ? n.substring(x, n.length) : "", T.fp = f,
                   (pt.test(n) || y) && (T.e = 0), this._pt = T, T
          },
          or =
              function(t, e, r, n, o, h, f, l, c) {
            $(n) && (n = n(o || 0, t, h));
            var _,
                d = t[e],
                m = "get" !== r ? r
                    : $(d)
                        ? c ? t[e.indexOf("set") || !$(t["get" + e.substr(3)])
                                    ? e
                                    : "get" + e.substr(3)](c)
                            : t[e]()
                        : d,
                v = $(d) ? c ? gr : mr : dr;
            if (J(n) && (~n.indexOf("random(") && (n = Ae(n)),
                         "=" === n.charAt(1) &&
                             ((_ = parseFloat(m) +
              ...
              return isNaN(m * n) || "" === n
                         ? (!d && !(e in t) && yt(e, n),
                            ar.call(this, t, e, m, n, v, l || U.stringFilter,
                                    c))
                         : (_ = new Dr(this._pt, t, e, +m || 0, n - (m || 0),
                                       "boolean" == typeof d ? xr : Tr, 0, v),
                            c && (_.fp = c), f && _.modifier(f, this, t),
                            this._pt = _)
          },
          ur =
            ...
            var f, l, c, i;
            if (kt[t] &&
                !1 !== (f = new kt[t]).init(o, f.rawVars ? e[t] : function(t, e, r, n, o) {
                  if ($(t) && (t = lr(t, o, e, r, n)),
                  ...
                  for (p in t)
                    h[p] = lr(t[p], o, e, r, n);
                  return h
                }(e[t], n, o, h, r), r, n, h) && (r._pt = l = new Dr(r._pt, o, t, 0, 1, f.render, f, 0, f.priority), r !== v))
              for (c = r._ptLookup[r._targets.indexOf(o)], i = f._props.length;
                   i--;)
                c[f._props[i]] = l;
            return f
          },
          fr =
              function t(e, time) {
            var r, i, p, n, o, l, c, _, d, m, v, y, T,
                x = e.vars, w = x.ease, O = x.startAt, M = x.immediateRender,
                k = x.lazy, A = x.onUpdate, C = x.onUpdateParams,
                D = x.callbackScope, P = x.runBackwards, S = x.yoyoEase,
                z = x.keyframes, R = x.autoRevert, F = e._dur, E = e._startAt,
                B = e._targets, I = e.parent,
                L = I && "nested" === I.data ? I.parent._targets : B,
                Y = "auto" === e._overwrite && !h, U = e.timeline;
            if (U && (!z || !w) && (w = "none"), e._ease = Ze(w, N.ease),
                e._yEase = S ? Qe(Ze(!0 === S ? w : S, N.ease)) : 0,
                S && e._yoyo && !e._repeat &&
                    (S = e._yEase, e._yEase = e._ease, e._ease = S),
                e._from = !U && !!x.runBackwards, !U) {
              if (y = (_ = B[0] ? zt(B[0]).harness : 0) && x[_.prop],
                  r = jt(x, bt), E && E.render(-1, !0).kill(), O)
                if (Qt(e._startAt = _r.set(B, Nt({
                                             data : "isStart",
                                             overwrite : !1,
                                             parent : I,
                                             immediateRender : !0,
                                             ...
                                             stagger : 0
                                                 ...
                                                 O))),
                    time < 0 && !M && !R && e._startAt.render(-1, !0), M) {
                  ...
                  !R && (e._startAt = 0);
                         ...
                         p = Nt({
                           ...
                           parent : I
                                ...
                                r),
                         y && (p[_.prop] = y), Qt(e._startAt = _r.set(B, p)),
                         time < 0 && e._startAt.render(-1, !0), M) {
                  if (!time)
                    return
                } else
                  t(e._startAt, V);
              for (e._pt = 0, k = F && it(k) || k && !F, i = 0; i < B.length;
                   i++) {
                if (c = (o = B[i])._gsap || St(B)[i]._gsap,
                    e._ptLookup[i] = m = {}, Mt[c.id] && Ot.length && It(),
                    v = L === B ? i : L.indexOf(o),
                    _ && !1 !== (d = new _).init(o, y || r, e, v, L) &&
                        (e._pt = n = new Dr(e._pt, o, d.name, 0, 1, d.render, d,
                                            0, d.priority),
                         d._props.forEach((function(t) { m[t] = n })),
                         d.priority && (l = 1)),
                    !_ || y)
                  for (p in r)
                    kt[p] && (d = ur(p, r, e, v, o, L))
                        ? d.priority && (l = 1)
                        : m[p] = n = or.call(e, o, p, "get", r[p], v, L, 0,
                                             x.stringFilter);
                e._op && e._op[i] && e.kill(o, e._op[i]),
                    Y && e._pt &&
                        (sr = e, f.killTweensOf(o, m, e.globalTime(0)),
                         T = !e.parent, sr = 0),
                    e._pt && k && (Mt[c.id] = 1)
              }
          ...
          lr =
              function(t, e, i, r, n) {
            return $(t)                            ? t.call(e, i, r, n)
                   : J(t) && ~t.indexOf("random(") ? Ae(t)
                                                   : t
          },
          pr = Pt + "repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase",
          cr = (pr + ",id,stagger,delay,duration,paused,scrollTrigger")
                   .split(","),
          _r = function(t) {
            function e(e, r, o, l) {
              var c;
              ...
              var _, i, d, m, p, v, y, T,
                  ...
                  w = x.duration, O = x.delay, M = x.immediateRender,
                  k = x.stagger, A = x.overwrite, C = x.keyframes,
                  D = x.defaults, P = x.scrollTrigger, S = x.yoyoEase,
                  z = r.parent || f,
                  R = (ot(e) || at(e) ? K(e[0]) : "length" in r) ? [ e ]
                                                                 : Te(e);
              if (c._targets = R.length
                                   ...
                                   : Tt("GSAP target " + e +
                                        ...
                                        !U.nullTargetWarn) ||
                                         [],
                  c._ptLookup = [], c._overwrite = A,
                  C || k || st(w) || st(O)) {
                if (r = c.vars,
                    (_ = c.timeline =
                         new nr({data : "nested", defaults : D || {}}))
                        .kill(),
                    _.parent = _._dp = n(c), _._start = 0, C)
                  Nt(_.vars.defaults, {ease : "none"}),
                      k ? R.forEach((function(t, i) {
                        return C.forEach((function(
                            e, r) { return _.to(t, e, r ? ">" : i * k) }))
                      }))
                        : C.forEach((function(t) { return _.to(R, t, ">") }));
                else {
                  if (m = R.length, y = k ? we(k) : wt, et(k))
                    for (p in k)
                      ~pr.indexOf(p) && (T || (T = {}), T[p] = k[p]);
                  for (i = 0; i < m; i++) {
                    for (p in d = {}, r)
                      cr.indexOf(p) < 0 && (d[p] = r[p]);
                    d.stagger = 0, S && (d.yoyoEase = S), T && qt(d, T),
                    v = R[i], d.duration = +lr(w, n(c), i, v, R),
                    d.delay = (+lr(O, n(c), i, v, R) || 0) - c._delay,
                    !k && 1 === m && d.delay &&
                        (c._delay = O = d.delay, c._start += O, d.delay = 0),
                    _.to(v, d, y(i, v, R))
                  }
                ...
                c.timeline = 0;
              return !0 !== A || h || (sr = n(c), f.killTweensOf(R), sr = 0),
                     ne(z, n(c), o), r.reversed && c.reverse(),
                     r.paused && c.paused(!0),
                     (M || !w && !C && c._start === Et(z._time) && it(M) &&
                               Jt(n(c)) && "nested" !== z.data) &&
            ...
            return r.render =
                       function(t, e, r) {
              var time, n, o, h, f, l, c, _, d, m = this._time, v = this._tDur,
                                                y = this._dur,
                                                T = t > v - V && t >= 0 ? v
                                                    : t < V             ? 0
                                                                        : t;
              if (y) {
                if (T !== this._tTime || !t || r ||
                  ...
                  if (time = T, _ = this.timeline, this._repeat) {
                    ...
                    o !== f &&
                        (_ && this._yEase && He(_, l),
                         !this.vars.repeatRefresh || l || this._lock ||
                             (this._lock = r = 1,
                              this.render(Et(h * o), !0).invalidate()._lock =
                                  0))
                  }
                  if (!this._initted) {
                  ...
                  if (this._tTime = T, this._time = time,
                  ...
                  _ && _.render(t < 0        ? t
                      ...
                      this._onUpdate && !e &&
                          (t < 0 && this._startAt &&
                           ...
                           Pe(this, "onUpdate")),
                      this._repeat && o !== f && this.vars.onRepeat && !e &&
                          this.parent && Pe(this, "onRepeat"),
                      T !== this._tDur && T || this._tTime !== T ||
                          (t < 0 && this._startAt && !this._onUpdate &&
                ...
                !function(t, e, r, n) {
                  var o, h, f,
                      ...
                      _ = t._rDelay, d = 0;
                  if (_ && t._repeat &&
                          (d = de(0, t._tDur, e), h = Kt(d, _),
                           f = Kt(t._tTime, _), t._yoyo && 1 & h && (c = 1 - c),
                           h !== f &&
                               (l = 1 - c, t.vars.repeatRefresh && t._initted &&
                                               t.invalidate())),
                      c !== l || n || t._zTime === V || !e && t._zTime) {
                    if (!t._initted && ae(t, e, n, r))
                      return;
                    for (f = t._zTime, t._zTime = e || (r ? V : 0),
                        r || (r = e && !f), t.ratio = c, t._from && (c = 1 - c),
                        t._time = 0, t._tTime = d, o = t._pt;
                         o;)
                      o.r(c, o.d), o = o._next;
                    t._startAt && e < 0 && t._startAt.render(e, !0, !0),
                        t._onUpdate && !r && Pe(t, "onUpdate"),
                        d && t._repeat && !r && t.parent && Pe(t, "onRepeat"),
                        (e >= t._tDur || e < 0) && t.ratio === c &&
                            (c && Qt(t, 1),
                             r || (Pe(t, c ? "onComplete" : "onReverseComplete",
                                      !0),
                                   t._prom && t._prom()))
                  } else
                    t._zTime || (t._zTime = e)
              ...
              return this
                   ...
                   r.targets = function() { return this._targets },
                   r.invalidate =
                       function() {
                     return this._pt = this._op = this._startAt =
                                this._onUpdate = this._lazy = this.ratio = 0,
                            this._ptLookup = [],
                   ...
                   r.kill =
                     ...
                     if (this.timeline) {
                       ...
                       return this.timeline
                                      .killTweensOf(
                                          t, e, sr && !0 !== sr.vars.overwrite)
                                      ._first ||
                                  Se(this),
                              this.parent &&
                                  r !== this.timeline.totalDuration() &&
                                  he(this, this._dur * this.timeline._tDur / r,
                                     0, 1),
                              this
                     }
                     var n, o, h, f, p, l, i, c = this._targets,
                                              _ = t ? Te(t) : c,
                                              d = this._ptLookup, m = this._pt;
                   ...
                   e.to = function(t, r) { return new e(t, r, arguments[2]) },
                   e.from = function(t, e) { return ce(1, arguments) },
                   e.delayedCall =
                       function(t, r, n, o) {
                     return new e(r, 0, {
                       immediateRender : !1,
                   ...
                   e.fromTo = function(t, e, r) { return ce(2, arguments) },
                   e.set =
                       function(t, r) {
                     return r.duration = 0, r.repeatDelay || (r.repeat = 0),
                            new e(t, r)
                   },
                   e.killTweensOf = function(
                       t, e, r) { return f.killTweensOf(t, e, r) },
                   e
          }(ir);
      Nt(_r.prototype,
         {_targets : [], _lazy : 0, _startAt : 0, _op : 0, _onInit : 0}),
          Ft("staggerTo,staggerFrom,staggerFromTo", (function(t) {
               _r[t] = function() {
                 var e = new nr, r = ge.call(arguments, 0);
                 return r.splice("staggerFromTo" === t ? 5 : 4, 0, 0),
                        e[t].apply(e, r)
               }
             }));
      var dr = function(t, e, r) { return t[e] = r },
          mr = function(t, e, r) { return t[e](r) },
          gr = function(t, e, r, data) { return t[e](data.fp, r) },
          vr = function(t, e, r) { return t.setAttribute(e, r) },
          yr = function(
              t,
              e) { return $(t[e])                      ? mr
                          : tt(t[e]) && t.setAttribute ? vr
                                                       : dr },
          Tr = function(t, data) {
            return data.set(data.t, data.p,
                            Math.round(1e6 * (data.s + data.c * t)) / 1e6, data)
          }, xr = function(t, data) {
            ...
            for (var e, r, n = this._pt; n;)
              r = n._next,
              n.p === t && !n.op || n.op === t ? Wt(this, n, "_pt")
                                               : n.dep || (e = 1),
              n = r;
            return !e
            ...
            function t(t, e, r, n, o, h, data, f, l) {
              this.t = e, this.s = n, this.c = o, this.p = r, this.r = h || Tr,
              this.d = data || this, this.set = f || dr, this.pr = l || 0,
              this._next = t, t && (t._prev = this)
            }
            return t.prototype.modifier = function(t, e, r) {
              this.mSet = this.mSet || this.set, this.set = Ar, this.m = t,
              this.mt = r, this.tween = e
            }, t
          }();
      Ft(Pt +
             "parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",
         (function(t) { return bt[t] = 1 })),
          mt.TweenMax = mt.TweenLite = _r,
          mt.TimelineLite = mt.TimelineMax = nr, f = new nr({
                                                   sortChildren : !1,
                                                   defaults : N,
      ...
      var Pr = {
        registerPlugin : function() {
          for (var t = arguments.length, e = new Array(t), r = 0; r < t; r++)
            e[r] = arguments[r];
          e.forEach((function(t) { return ze(t) }))
        },
        timeline : function(t) { return new nr(t) },
        getTweensOf : function(t, e) { return f.getTweensOf(t, e) },
        getProperty : function(t, e, r, n) {
          J(t) && (t = Te(t)[0]);
          var o = zt(t || {}).get, h = r ? Ut : Yt;
          return "native" === r && (r = ""),
                 t ? e ? h((kt[e] && kt[e].get || o)(t, e, r, n)) : function(e, r, n) {
                   return h((kt[e] && kt[e].get || o)(t, e, r, n))
                 } : t
        },
        quickSetter : function(t, e, r) {
          if ((t = Te(t)).length > 1) {
            var n = t.map((function(t) { return Rr.quickSetter(t, e, r) })),
                o = n.length;
            return function(t) {
              for (var i = o; i--;)
                n[i](t)
          ...
          var h = kt[e], f = zt(t),
              ...
              l = h ? function(e) {
                var p = new h;
                v._pt = 0, p.init(t, r ? e + r : e, v, 0, [ t ]),
                p.render(1, p), v._pt && Or(1, v)
              } : f.set(t, p);
          return h ? l : function(e) { return l(t, p, r ? e + r : e, f, 1) }
        },
        isTweening : function(t) { return f.getTweensOf(t, !0).length > 0 },
        defaults : function(t) {
          return t && t.ease && (t.ease = Ze(t.ease, N.ease)), Vt(N, t || {})
        },
        config : function(t) { return Vt(U, t || {}) },
        registerEffect : function(t) {
          var e = t.name, r = t.effect, n = t.plugins, o = t.defaults,
              h = t.extendTimeline;
          (n || "").split(",").forEach((function(t) {
            return t && !kt[t] && !mt[t] &&
                   Tt(e + " effect requires " + t + " plugin.")
          })),
              At[e] = function(t, e, n) { return r(Te(t), Nt(e || {}, o), n) },
              h && (nr.prototype[e] = function(t, r, n) {
                return this.add(At[e](t, et(r) ? r : (n = r) && {}, this), n)
              })
        },
        registerEase : function(t, e) { Ve[t] = Ze(e) },
        parseEase : function(t, e) { return arguments.length ? Ze(t, e) : Ve },
        getById : function(t) { return f.getById(t) },
        exportRoot : function(t, e) {
          void 0 === t && (t = {});
          var r, n, o = new nr(t);
          for (o.smoothChildTiming = it(t.smoothChildTiming), f.remove(o),
              o._dp = 0, o._time = o._tTime = f._time, r = f._first;
               r;)
            n = r._next,
            !e && !r._dur && r instanceof _r &&
        ...
        utils : {
          wrap : function t(e, r, n) {
            ...
            return ot(e)
                       ? ke(e, t(0, e.length), r)
                       : _e(n,
                            (function(t) { return (o + (t - e) % o) % o + e }))
          },
          wrapYoyo : function t(e, r, n) {
            var o = r - e, h = 2 * o;
            return ot(e) ? ke(e, t(0, e.length - 1), r)
                         : _e(n, (function(t) {
                                return e + ((t = (h + (t - e) % h) % h || 0) > o
                                                ? h - t
                                                : t)
                              }))
          },
          ...
          random : Me,
          snap : Oe,
          normalize : function(t, e, r) { return Ce(t, e, 0, 1, r) },
          getUnit : me,
          clamp : function(
              t, e, r) { return _e(r, (function(r) { return de(t, e, r) })) },
          splitColor : Be,
          toArray : Te,
          selector : function(t) {
            return t = Te(t)[0] || Tt("Invalid scope") || {}, function(e) {
              var r = t.current || t.nativeElement || t;
              return Te(e, r.querySelectorAll ? r
                           : r === t
          ...
          pipe : function() {
            for (var t = arguments.length, e = new Array(t), r = 0; r < t; r++)
              e[r] = arguments[r];
            return function(
                t) { return e.reduce((function(t, e) { return e(t) }), t) }
          },
          unitize : function(t, e) {
            return function(r) { return t(parseFloat(r)) + (e || me(r)) }
          },
          interpolate : function t(e, r, progress, n) {
            var o =
                isNaN(e + r) ? 0 : function(p) { return (1 - p) * e + p * r };
            if (!o) {
              var p, i, h, f, l, c = J(e), _ = {};
              ...
              if (!h) {
                for (p in r)
                  or.call(_, e, p, "get", r[p]);
                o = function(p) { return Or(p, _) || (c ? e.p : e) }
              }
            }
        ...
        core : {
          ...
          suppressOverwrites : function(t) { return h = t }
        }
      };
      Ft("to,from,fromTo,delayedCall,set,killTweensOf",
         (function(t) { return Pr[t] = _r[t] })),
          Xe.add(nr.updateRoot), v = Pr.to({}, {duration : 0});
      var Sr =
              function(t, e) {
        ...
        return r
            ...
            return {
              name: t, rawVars: 1, init: function(t, r, n) {
                n._onInit = function(t) {
                  var n, p;
                  if (J(r) && (n = {}, Ft(r, (function(t) { return n[t] = 1 })),
                               r = n),
                      e) {
                    for (p in n = {}, r)
                      n[p] = e(r[p]);
          ...
          Rr = Pr.registerPlugin({
            name : "attr",
            init : function(t, e, r, n, o) {
              var p, h;
              for (p in e)
                (h = this.add(t, "setAttribute", (t.getAttribute(p) || 0) + "",
                              e[p], n, o, 0, 0, p)) &&
                    (h.op = p),
                    this._props.push(p)
            }
                                 ...
                                 zr("roundProps", be), zr("modifiers"),
                                 zr("snap", Oe)) ||
               Pr;
      _r.version = nr.version = Rr.version = "3.7.1", d = 1, nt() && qe();
      Ve.Power0, Ve.Power1, Ve.Power2, Ve.Power3, Ve.Power4, Ve.Linear, Ve.Quad,
          Ve.Cubic, Ve.Quart, Ve.Quint, Ve.Strong, Ve.Elastic, Ve.Back,
          Ve.SteppedEase, Ve.Bounce, Ve.Sine, Ve.Expo, Ve.Circ;
      var Fr, Er, Br, Ir, Lr, Yr, Ur,
          Nr = {}, Xr = 180 / Math.PI, qr = Math.PI / 180, Vr = Math.atan2,
          jr = /([A-Z])/g, Gr = /(?:left|right|width|margin|padding|x)/i,
          Wr = /[\s,\(]\S/, Qr = {
          ...
          Hr =
            ...
            return data.set(
                data.t, data.p,
                Math.round(1e4 * (data.s + data.c * t)) / 1e4 + data.u, data)
          },
          Zr =
              function(t, data) {
            return data.set(
          ...
          Jr =
              function(t, data) {
            return data.set(data.t, data.p,
                            t ? Math.round(1e4 * (data.s + data.c * t)) / 1e4 +
                                    data.u
                              : data.b,
                            data)
          },
          ...
          ei = function(t, e, r) { return t.style[e] = r },
          ri = function(t, e, r) { return t.style.setProperty(e, r) },
          ii = function(t, e, r) { return t._gsap[e] = r },
          ni = function(t, e, r) { return t._gsap.scaleX = t._gsap.scaleY = r },
          si =
              function(t, e, r, data, n) {
            var o = t._gsap;
          ...
          oi = "transform", ui = oi + "Origin",
          hi =
              function(t, e) {
            var r =
                Er.createElementNS
                    ? Er.createElementNS((e || "http://www.w3.org/1999/xhtml")
                                             .replace(/^https/, "http"),
                                         t)
                    : Er.createElement(t);
            ...
            return o[r] ||
                   ...
                   o.getPropertyValue(r) || !n && t(e, ci(r) || r, 1) || ""
          },
          pi = "O,Moz,ms,Ms,Webkit".split(","),
          ci =
              function(t, element, e) {
            var s = (element || Lr).style, i = 5;
            if (t in s && !e)
              return t;
          ...
          _i =
            ...
            "undefined" != typeof window && window.document &&
                (Fr = window, Er = Fr.document, Br = Er.documentElement,
                 Lr = hi("div") || {style : {}}, hi("div"), oi = ci(oi),
                 ui = oi + "Origin",
                 Lr.style.cssText =
                     "border-width:0;line-height:0;position:absolute;padding:0",
                 Ur = !!ci("perspective"), Ir = 1)
          },
          di =
              function t(e) {
            var r,
                ...
                n = this.parentNode, o = this.nextSibling,
                h = this.style.cssText;
            if (Br.appendChild(svg), svg.appendChild(this),
                this.style.display = "block", e)
              try {
                r = this.getBBox(), this._gsapBBox = this.getBBox,
                this.getBBox = t
              } catch (t) {
              }
            else
            ...
            return n && (o ? n.insertBefore(this, o) : n.appendChild(this)),
                   Br.removeChild(svg), this.style.cssText = h, r
          },
          mi =
              function(t, e) {
            for (var i = e.length; i--;)
          ...
          gi =
            ...
            return e && (e.width || e.height) || t.getBBox === di ||
                       (e = di.call(t, !0)),
                   !e || e.width || e.x || e.y ? e : {
                     x : +mi(t, [ "x", "cx", "x1" ]) || 0,
                     y : +mi(t, [ "y", "cy", "y1" ]) || 0,
            ...
            return o === d || !_ || xi[o] || xi[d]
                       ...
                       : ("px" !== d && !x && (_ = t(e, r, n, "px")),
                          ...
                          !w && "%" !== d || !Nr[r] && !~r.indexOf("adius")
                              ? (style[m ? "width" : "height"] =
                                     T + (x ? d : o),
                                 f = ~r.indexOf("adius") ||
                                             "em" === o && e.appendChild && !v
                                         ? e
                                         : e.parentNode,
                                 c &&
                                     (f = (e.ownerSVGElement || {}).parentNode),
                                 f && f !== Er && f.appendChild ||
                                     (f = Er.body),
                                 (l = f._gsap) && w && l.width && m &&
                                         l.time === Xe.time
                                     ? Et(_ / l.width * T)
                                     : ((w || "%" === d) &&
                                            (style.position =
          ...
          bi =
            ...
            var o;
            return Ir || _i(),
                   e in Qr && "transform" !== e && ~(e = Qr[e]).indexOf(",") &&
                       (e = e.split(",")[0]),
                   Nr[e] && "transform" !== e
                       ? (o = Fi(t, n),
                          o = "transformOrigin" !== e ? o[e]
                              : o.svg                 ? o.origin
                                      : Ei(fi(t, ui)) + " " + o.zOrigin + "px")
                       : (!(o = t.style[e]) || "auto" === o || n ||
                          ~(o + "").indexOf("calc(")) &&
                             (o = Ai[e] && Ai[e](t, e, r) || fi(t, e) ||
                                  Rt(t, e) || ("opacity" === e ? 1 : 0)),
                   r && !~(o + "").trim().indexOf(" ") ? wi(t, e, o, r) + r : o
          },
          Oi =
              function(t, e, r, n) {
            if (!r || "none" === r) {
              var p = ci(e, t, 1), s = p && fi(t, p, 1);
              s && s !== r
                  ? (e = p, r = s)
                  : "borderColor" === e && (r = fi(t, "borderTopColor"))
            }
            var a, o, h, f, l, c, _, d, m, v, y, T,
                x = new Dr(this._pt, t.style, e, 0, 1, wr), w = 0, O = 0;
            if (x.b = r, x.e = n, r += "",
                "auto" === (n += "") &&
                    (t.style[e] = n, n = fi(t, e) || n, t.style[e] = r),
                Ne(a = [ r, n ]), n = a[1], h = (r = a[0]).match(ft) || [],
                (n.match(ft) || []).length) {
              for (; o = ft.exec(n);)
                _ = o[0], m = n.substring(w, o.index),
                l ? l = (l + 1) % 5
                  : "rgba(" !== m.substr(-5) && "hsla(" !== m.substr(-5) ||
                        (l = 1),
                _ !== (c = h[O++] || "") &&
                    (f = parseFloat(c) || 0, y = c.substr((f + "").length),
                     (T = "=" === _.charAt(1) ? +(_.charAt(0) + "1") : 0) &&
                         (_ = _.substr(2)),
                     d = parseFloat(_), v = _.substr((d + "").length),
                     w = ft.lastIndex - v.length,
                     v || (v = v || U.units[e] || y,
                           w === n.length && (n += v, x.e += v)),
                     y !== v && (f = wi(t, e, c, v) || 0), x._pt = {
                       _next : x._pt,
                       p : m || 1 === O ? m : ",",
                       s : f,
                       c : T ? T * d : d - f,
          ...
          ki =
            ...
            if (data.tween && data.tween._time === data.tween._dur) {
              var e, r, i, n = data.t, style = n.style, o = data.u, h = n._gsap;
              if ("all" === o || !0 === o)
                style.cssText = "", r = 1;
              else
                for (i = (o = o.split(",")).length; --i > -1;)
                  ...
                  yi(n, e);
              r && (yi(n, oi), h && (h.svg && n.removeAttribute("transform"),
                                     Fi(n, 1), h.uncache = 1))
            }
          },
          Ai = {
            clearProps : function(t, e, r, n, o) {
              if ("isFromStart" !== o.data) {
                ...
                return h.u = n, h.pr = -10, h.tween = o, t._props.push(r), 1
              }
            }
          },
          Ci = [ 1, 0, 0, 1, 0, 0 ], Di = {}, Pi = function(t) {
            return "matrix(1, 0, 0, 1, 0, 0)" === t || "none" === t || !t
          }, Si = function(t) {
            var e = fi(t, oi);
            return Pi(e) ? Ci : e.substr(7).match(ht).map(Et)
          }, zi = function(t, e) {
            var r, n, o, h, f = t._gsap || zt(t), style = t.style, l = Si(t);
            return f.svg && t.getAttribute("transform")
                       ? "1,0,0,1,0,0" ===
                                 (l =
                                      [
                                        (o = t.transform.baseVal.consolidate()
                                                 .matrix)
                                            .a,
                                        o.b, o.c, o.d, o.e, o.f
                                      ])
                             ...
                             ? Ci
                             : l
                       : (l !== Ci || t.offsetParent || t === Br || f.svg ||
                              (o = style.display, style.display = "block",
                               (r = t.parentNode) && t.offsetParent ||
                                   (h = 1, n = t.nextSibling,
                                    Br.appendChild(t)),
                               l = Si(t),
                               o ? style.display = o : yi(t, "display"),
                               h && (n   ? r.insertBefore(t, n)
                                     : r ? r.appendChild(t)
                                         : Br.removeChild(t))),
                          e && l.length > 6
            ...
            var f, l, c, _ = t._gsap, d = o || zi(t, !0), m = _.xOrigin || 0,
                         v = _.yOrigin || 0, y = _.xOffset || 0,
                         T = _.yOffset || 0, a = d[0], b = d[1], x = d[2],
                         w = d[3], O = d[4], M = d[5], k = e.split(" "),
                         A = parseFloat(k[0]) || 0, C = parseFloat(k[1]) || 0;
            r ? d !== Ci && (l = a * w - b * x) &&
                    (c = A * (-b / l) + C * (a / l) - (a * M - b * O) / l,
                     A = A * (w / l) + C * (-x / l) + (x * M - w * O) / l,
                     C = c)
              : (A = (f = gi(t)).x +
                     (~k[0].indexOf("%") ? A / 100 * f.width : A),
                 C = f.y +
                ...
                n || !1 !== n && _.smooth
                    ...
                    : _.xOffset = _.yOffset = 0,
                      _.xOrigin = A, _.yOrigin = C, _.smooth = !!n,
                      _.origin = e, _.originIsAbsolute = !!r,
                      t.style[ui] = "0px 0px",
                      h &&
                          (Ti(h, _, "xOrigin", m, A), Ti(h, _, "yOrigin", v, C),
            ...
            if ("x" in r && !e && !r.uncache)
              return r;
            var n, o, h, f, l, c, _, d, m, v, y, T, x, w, O, M, k, a, b, A, C,
                D, P, S, z, R, F, E, B, I, L, Y,
                style = t.style, N = r.scaleX < 0, X = "px", V = "deg",
                j = fi(t, ui) || "0";
            return n = o = h = c = _ = d = m = v = y = 0, f = l = 1,
                   r.svg = !(!t.getCTM || !vi(t)), w = zi(t, r.svg),
                   r.svg && (S = (!r.uncache || "0px 0px" === j) && !e &&
                                 t.getAttribute("data-svg-origin"),
                             Ri(t, S || j, !!S || r.originIsAbsolute,
                                !1 !== r.smooth, w)),
                   T = r.xOrigin || 0, x = r.yOrigin || 0,
                   w !== Ci &&
                       (a = w[0], b = w[1], A = w[2], C = w[3], n = D = w[4],
                        o = P = w[5],
                        6 === w.length
                            ? (f = Math.sqrt(a * a + b * b),
                               l = Math.sqrt(C * C + A * A),
                               ...
                               r.svg && (n -= T - (T * a + x * A),
                                         o -= x - (T * b + x * C)))
                            : (Y = w[6], I = w[7], F = w[8], E = w[9],
                               B = w[10], L = w[11], n = w[12], o = w[13],
                               h = w[14], _ = (O = Vr(Y, B)) * Xr,
                               O && (S = D * (M = Math.cos(-O)) +
                                         F * (k = Math.sin(-O)),
                                     z = P * M + E * k, R = Y * M + B * k,
                                     F = D * -k + F * M, E = P * -k + E * M,
                               ...
                               O && (S = a * (M = Math.cos(O)) +
                                     ...
                                     z = D * M + P * k, b = b * M - a * k,
                                     P = P * M - D * k, a = S, D = z),
                               _ && Math.abs(_) + Math.abs(c) > 359.9 &&
                                   (_ = c = 0, d = 180 - d),
                               f = Et(Math.sqrt(a * a + b * b + A * A)),
                               l = Et(Math.sqrt(P * P + Y * Y)), O = Vr(D, P),
                   ...
                   Math.abs(m) > 90 && Math.abs(m) < 270 &&
                       (N ? (f *= -1, m += c <= 0 ? 180 : -180,
                             c += c <= 0 ? 180 : -180)
                          : (l *= -1, m += m <= 0 ? 180 : -180)),
                   r.x = n -
                         ((r.xPercent = n && (r.xPercent ||
                   ...
                   r.y = o -
                         ((r.yPercent = o && (r.yPercent ||
                              ...
                              : 0) +
                         X,
                   r.z = h + X, r.scaleX = Et(f), r.scaleY = Et(l),
                   r.rotation = Et(c) + V, r.rotationX = Et(_) + V,
                   r.rotationY = Et(d) + V, r.skewX = m + V, r.skewY = v + V,
                   r.transformPerspective = y + X,
                   (r.zOrigin = parseFloat(j.split(" ")[2]) || 0) &&
                       (style[ui] = Ei(j)),
                   r.xOffset = r.yOffset = 0, r.force3D = U.force3D,
                   r.renderTransform = r.svg ? Xi
                                       : Ur  ? Ni
                                             : Ii,
                   r.uncache = 0, r
          }, Ei = function(t) {
            ...
            Ni(t, e)
          }, Li = "0deg", Yi = "0px", Ui = ") ", Ni = function(t, e) {
            var r = e || this, n = r.xPercent, o = r.yPercent, h = r.x, f = r.y,
                l = r.z, c = r.rotation, _ = r.rotationY, d = r.rotationX,
                m = r.skewX, v = r.skewY, y = r.scaleX, T = r.scaleY,
                x = r.transformPerspective, w = r.force3D, O = r.target,
                M = r.zOrigin, k = "",
                A = "auto" === w && t && 1 !== t || !0 === w;
            if (M && (d !== Li || _ !== Li)) {
              var C, D = parseFloat(_) * qr, P = Math.sin(D), S = Math.cos(D);
              D = parseFloat(d) * qr, C = Math.cos(D), h = Bi(O, h, P * C * -M),
              f = Bi(O, f, -Math.sin(D) * -M), l = Bi(O, l, S * C * -M + M)
            }
            ...
            var r, n, o, h, f,
                l = e || this, c = l.xPercent, _ = l.yPercent, d = l.x, m = l.y,
                v = l.rotation, y = l.skewX, T = l.skewY, x = l.scaleX,
                w = l.scaleY, O = l.target, M = l.xOrigin, k = l.yOrigin,
                A = l.xOffset, C = l.yOffset, D = l.forceCSS, P = parseFloat(d),
                S = parseFloat(m);
            v = parseFloat(v), y = parseFloat(y),
            (T = parseFloat(T)) && (y += T = parseFloat(T), v += T),
            v || y
                ? (v *= qr, y *= qr, r = Math.cos(v) * x, n = Math.sin(v) * x,
                   o = Math.sin(v - y) * -w, h = Math.cos(v - y) * w,
                   y && (T *= qr, f = Math.tan(y - T),
                         o *= f = Math.sqrt(1 + f * f), h *= f,
                         T && (f = Math.tan(T), r *= f = Math.sqrt(1 + f * f),
                               n *= f)),
                   r = Et(r), n = Et(n), o = Et(o), h = Et(h))
                : (r = x, h = w, n = o = 0),
            (P && !~(d + "").indexOf("px") || S && !~(m + "").indexOf("px")) &&
                (P = wi(O, "x", d, "px"), S = wi(O, "y", m, "px")),
            (M || k || A || C) && (P = Et(P + M - (M * r + k * o) + A),
                                   S = Et(S + k - (M * n + k * h) + C)),
            (c || _) && (f = O.getBBox(), P = Et(P + c / 100 * f.width),
                         S = Et(S + _ / 100 * f.height)),
            f = "matrix(" + r + "," + n + "," + o + "," + h + "," + P + "," +
                S + ")",
            O.setAttribute("transform", f), D && (O.style[oi] = f)
          }, qi = function(t, e, r, n, o, h) {
            var f, l, c = 360, _ = J(o),
                      d = parseFloat(o) * (_ && ~o.indexOf("rad") ? Xr : 1),
                      m = h ? d * h : d - n, v = n + m + "deg";
            return _ && ("short" === (f = o.split("_")[1]) &&
                             (m %= c) !== m % 180 && (m += m < 0 ? c : -360),
                         "cw" === f && m < 0
                             ? m = (m + 36e9) % c - ~~(m / c) * c
                             : "ccw" === f && m > 0 &&
                                   (m = (m - 36e9) % c - ~~(m / c) * c)),
                   t._pt = l = new Dr(t._pt, e, r, n, m, Zr), l.e = v,
                   l.u = "deg", t._props.push(r), l
          }, Vi = function(t, source) {
            for (var p in source)
              t[p] = source[p];
            return t
          }, ji = function(t, e, r) {
            var n, p, o, h, f, l, c, _ = Vi({}, r._gsap), style = r.style;
            for (p in _.svg
                     ? (o = r.getAttribute("transform"),
                       r.setAttribute("transform", ""), style[oi] = e,
                       n = Fi(r, 1), yi(r, oi), r.setAttribute("transform", o))
                     : (o = getComputedStyle(r)[oi], style[oi] = e,
                       n = Fi(r, 1), style[oi] = o),
                 Nr)
              (o = _[p]) !== (h = n[p]) &&
                  "perspective,force3D,transformOrigin,svgOrigin".indexOf(p) <
                      0 &&
                  (f = me(o) !== (c = me(h)) ? wi(r, p, o, c) : parseFloat(o),
                   l = parseFloat(h), t._pt = new Dr(t._pt, n, p, f, l - f, Hr),
                   t._pt.u = c || 0, t._props.push(p));
            Vi(n, _)
          };
      Ft("padding,margin,Width,Radius", (function(t, e) {
           var r = "Top", n = "Right", b = "Bottom", o = "Left",
               h = (e < 3 ? [ r, n, b, o ] : [ r + o, r + n, b + n, b + o ])
                       .map((function(
                           r) { return e < 2 ? t + r : "border" + r + t }));
           Ai[e > 1 ? "border" + t : t] = function(t, e, r, n, o) {
             var a, f;
             if (arguments.length < 4)
               return a = h.map((function(e) { return bi(t, e, r) })),
                      5 === (f = a.join(" ")).split(a[0]).length ? a[0] : f;
             a = (n + "").split(" "), f = {},
             h.forEach((function(
                 t, i) { return f[t] = a[i] = a[i] || a[(i - 1) / 2 | 0] })),
             t.init(e, f, o)
           }
         }));
      var Gi, Wi, Qi, Hi = {
        ...
        init : function(t, e, r, n, o) {
          var h, f, l, c, _, d, p, m, v, y, T, x, w, O, M, k, A, C, D,
              P = this._props, style = t.style, S = r.vars.startAt;
          for (p in Ir || _i(), e)
            if ("autoRound" !== p &&
                (f = e[p], !kt[p] || !ur(p, e, r, n, t, o)))
              if (_ = typeof f, d = Ai[p],
                  "function" === _ && (_ = typeof (f = f.call(r, n, t, o))),
                  "string" === _ && ~f.indexOf("random(") && (f = Ae(f)), d)
                d(this, t, p, f, r) && (M = 1);
              else if ("--" === p.substr(0, 2))
                h = (getComputedStyle(t).getPropertyValue(p) + "").trim(),
                f += "", Ye.lastIndex = 0, Ye.test(h) || (m = me(h), v = me(f)),
                v ? m !== v && (h = wi(t, p, h, v) + v) : m && (f += m),
                this.add(style, "setProperty", h, f, n, o, 0, 0, p), P.push(p);
              else if ("undefined" !== _) {
                if (S && p in S
                        ? (h = "function" == typeof S[p] ? S[p].call(r, n, t, o)
                                                         : S[p],
                           p in U.units && !me(h) && (h += U.units[p]),
                           "=" === (h + "").charAt(1) && (h = bi(t, p)))
                        : h = bi(t, p),
                    c = parseFloat(h),
                    (y = "string" === _ && "=" === f.charAt(1)
                             ? +(f.charAt(0) + "1")
                             : 0) &&
                        (f = f.substr(2)),
                    l = parseFloat(f),
                    p in Qr &&
                        ("autoAlpha" === p &&
                             (1 === c && "hidden" === bi(t, "visibility") &&
                                  l && (c = 0),
                              Ti(this, style, "visibility",
                                 c ? "inherit" : "hidden",
                                 l ? "inherit" : "hidden", !l)),
                         "scale" !== p && "transform" !== p &&
                             ~(p = Qr[p]).indexOf(",") &&
                  ...
                  if (x ||
                          ((w = t._gsap).renderTransform && !e.parseTransform ||
                           ...
                           (x = this._pt = new Dr(this._pt, style, oi, 0, 1,
                                                  w.renderTransform, w, 0, -1))
                               .dep = 1),
                      "scale" === p)
                    this._pt = new Dr(this._pt, w, "scaleY", w.scaleY,
                                      (y ? y * l : l - w.scaleY) || 0),
                    P.push("scaleY", p), p += "X";
                  else {
                    if ("transformOrigin" === p) {
                      A = void 0, C = void 0, D = void 0,
                      A = (k = f).split(" "), C = A[0], D = A[1] || "50%",
                      "top" !== C && "bottom" !== C && "left" !== D &&
                              "right" !== D ||
                          (k = C, C = D, D = k),
                      A[0] = Mi[C] || C, A[1] = Mi[D] || D, f = A.join(" "),
                      w.svg ? Ri(t, f, 0, O, 0, this)
                  ...
                  p in style || (p = ci(p) || p);
                if (T || (l || 0 === l) && (c || 0 === c) && !Wr.test(f) &&
                             p in style)
                  l || (l = 0),
                      (m = (h + "").substr((c + "").length)) !==
                              (v = me(f) || (p in U.units ? U.units[p] : m)) &&
                          (c = wi(t, p, h, v)),
                      this._pt = new Dr(this._pt, T ? w : style, p, c,
                                        y ? y * l : l - c,
                                        T || "px" !== v && "zIndex" !== p ||
                                                !1 === e.autoRound
                                            ? Hr
      ...
      Rr.utils
          .checkPrefix = ci,
  Qi = Ft((Gi = "x,y,z,scale,scaleX,scaleY,xPercent,yPercent") + "," +
              (Wi = "rotation,rotationX,rotationY,skewX,skewY") +
              ",transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective",
          (function(t) { Nr[t] = 1 })),
  Ft(Wi, (function(t) { U.units[t] = "deg", Di[t] = 1 })),
  Qr[Qi[13]] = Gi + "," + Wi,
  Ft("0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY",
     (function(t) {
       var e = t.split(":");
       Qr[e[1]] = Qi[e[0]]
     })),
  Ft("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",
     (function(t) { U.units[t] = "px" })),
