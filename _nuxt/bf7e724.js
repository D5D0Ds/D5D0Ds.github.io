      ...
      var r = n(222),
        ...
        l = {
          mounted: function () {
            ...
            var t = new o.Raycaster(),
              n = new o.Scene(),
              c = new o.PerspectiveCamera(
                75,
            ...
            l.setSize(innerWidth, innerHeight),
              l.setPixelRatio(devicePixelRatio),
              new d.a(c, l.domElement),
              (c.position.z = 50);
            var h = new o.PlaneGeometry(
                e.width,
                e.height,
                e.widthSegments,
                e.heightSegments
            ...
            n.add(f),
              (function () {
                ...
                for (
                  var t = f.geometry.attributes.position.array, n = [], i = 0;
                  i < t.length;
                  i++
                ) {
                  if (i % 3 == 0) {
                    var r = t[i],
                      c = t[i + 1],
                      d = t[i + 2];
                    (t[i] = r + 3 * (Math.random() - 0.5)),
                      (t[i + 1] = c + 3 * (Math.random() - 0.5)),
                      (t[i + 2] = d + 3 * (Math.random() - 0.5));
                  }
                ...
                for (
                  var l = [], h = 0;
                  h < f.geometry.attributes.position.count;
                  h++
                )
                  l.push(0, 0.19, 0.4);
                f.geometry.setAttribute(
                  "color",
                  new o.BufferAttribute(new Float32Array(l), 3)
                );
              })();
            ...
            for (
              var w = new o.BufferGeometry(),
                x = new o.PointsMaterial({ color: 16777215 }),
                S = [],
                i = 0;
              i < 1e4;
              i++
            ) {
              var M = 2e3 * (Math.random() - 0.5),
                _ = 2e3 * (Math.random() - 0.5),
                P = 2e3 * (Math.random() - 0.5);
              S.push(M, _, P);
            }
            w.setAttribute("position", new o.Float32BufferAttribute(S, 3));
            var W = new o.Points(w, x);
            n.add(W);
            var k = { x: void 0, y: void 0 },
              Y = 0;
            !(function animate() {
              requestAnimationFrame(animate),
                ...
                (Y += 0.01);
              for (
                var e = f.geometry.attributes.position,
                  o = e.array,
                ...
                (o[m] = d[m] + 0.01 * Math.cos(Y + h[m])),
                  (o[m + 1] = d[m + 1] + 0.001 * Math.sin(Y + h[m + 1]));
              f.geometry.attributes.position.needsUpdate = !0;
              var y = t.intersectObject(f);
              if (y.length > 0) {
                var v = y[0].object.geometry.attributes.color;
                v.setX(y[0].face.a, 0.1),
                  v.setY(y[0].face.a, 0.5),
                  v.setZ(y[0].face.a, 1),
                  v.setX(y[0].face.b, 0.1),
                  v.setY(y[0].face.b, 0.5),
                  v.setZ(y[0].face.b, 1),
                  v.setX(y[0].face.c, 0.1),
                  v.setY(y[0].face.c, 0.5),
                  v.setZ(y[0].face.c, 1),
                  (y[0].object.geometry.attributes.color.needsUpdate = !0);
                var w = { r: 0, g: 0.19, b: 0.4 },
                  x = { r: 0.1, g: 0.5, b: 1 };
                r.a.to(x, {
                  r: w.r,
                  g: w.g,
                  ...
                  duration: 1,
                  onUpdate: function () {
                    v.setX(y[0].face.a, x.r),
                      v.setY(y[0].face.a, x.g),
                      v.setZ(y[0].face.a, x.b),
                      v.setX(y[0].face.b, x.r),
                      v.setY(y[0].face.b, x.g),
                      v.setZ(y[0].face.b, x.b),
                      v.setX(y[0].face.c, x.r),
                      v.setY(y[0].face.c, x.g),
                      v.setZ(y[0].face.c, x.b),
                      (v.needsUpdate = !0);
                  },
                });
              }
